...
type ICommentRepositoryMock struct {
	...
	funcGetAll          func(ctx context.Context, u1 uuid.UUID) (cpa1 []*models.Comment, err error)
...
func (mmGetAll *mICommentRepositoryMockGetAll) Expect(ctx context.Context, u1 uuid.UUID) *mICommentRepositoryMockGetAll {
	...
	mmGetAll.defaultExpectation.params = &ICommentRepositoryMockGetAllParams{ctx, u1}
...
func (mmGetAll *mICommentRepositoryMockGetAll) Inspect(f func(ctx context.Context, u1 uuid.UUID)) *mICommentRepositoryMockGetAll {
...
func (mmGetAll *mICommentRepositoryMockGetAll) Set(f func(ctx context.Context, u1 uuid.UUID) (cpa1 []*models.Comment, err error)) *ICommentRepositoryMock {
	if mmGetAll.defaultExpectation != nil {
...
// Then helper
func (mmGetAll *mICommentRepositoryMockGetAll) When(ctx context.Context, u1 uuid.UUID) *ICommentRepositoryMockGetAllExpectation {
	if mmGetAll.mock.funcGetAll != nil {
		mmGetAll.mock.t.Fatalf("ICommentRepositoryMock.GetAll mock is already set by Set")
	}
	...
	expectation := &ICommentRepositoryMockGetAllExpectation{
		mock:   mmGetAll.mock,
		params: &ICommentRepositoryMockGetAllParams{ctx, u1},
	}
...
func (mmGetAll *ICommentRepositoryMock) GetAll(ctx context.Context, u1 uuid.UUID) (cpa1 []*models.Comment, err error) {
	...
	mm_params := &ICommentRepositoryMockGetAllParams{ctx, u1}
	...
	if mmGetAll.GetAllMock.defaultExpectation != nil {
		...
		mm_got := ICommentRepositoryMockGetAllParams{ctx, u1}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	mmGetAll.t.Fatalf("Unexpected call to ICommentRepositoryMock.GetAll. %v %v", ctx, u1)
	return
}
