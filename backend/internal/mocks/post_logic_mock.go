...
type IPostLogicMock struct {
	...
	funcGetAll          func(ctx context.Context, u1 uuid.UUID) (ppa1 []*models.Post, err error)
	inspectFuncGetAll   func(ctx context.Context, u1 uuid.UUID)
	afterGetAllCounter  uint64
	beforeGetAllCounter uint64
	GetAllMock          mIPostLogicMockGetAll

	funcGetAllComments          func(ctx context.Context, postID uuid.UUID) (cpa1 []*models.Comment, err error)
	inspectFuncGetAllComments   func(ctx context.Context, postID uuid.UUID)
...
func (mmGetAll *mIPostLogicMockGetAll) Expect(ctx context.Context, u1 uuid.UUID) *mIPostLogicMockGetAll {
	...
	mmGetAll.defaultExpectation.params = &IPostLogicMockGetAllParams{ctx, u1}
...
func (mmGetAll *mIPostLogicMockGetAll) Inspect(f func(ctx context.Context, u1 uuid.UUID)) *mIPostLogicMockGetAll {
...
func (mmGetAll *mIPostLogicMockGetAll) Set(f func(ctx context.Context, u1 uuid.UUID) (ppa1 []*models.Post, err error)) *IPostLogicMock {
	if mmGetAll.defaultExpectation != nil {
...
// Then helper
func (mmGetAll *mIPostLogicMockGetAll) When(ctx context.Context, u1 uuid.UUID) *IPostLogicMockGetAllExpectation {
	if mmGetAll.mock.funcGetAll != nil {
		mmGetAll.mock.t.Fatalf("IPostLogicMock.GetAll mock is already set by Set")
	}
	...
	expectation := &IPostLogicMockGetAllExpectation{
		mock:   mmGetAll.mock,
		params: &IPostLogicMockGetAllParams{ctx, u1},
	}
...
func (mmGetAll *IPostLogicMock) GetAll(ctx context.Context, u1 uuid.UUID) (ppa1 []*models.Post, err error) {
	...
	mm_params := &IPostLogicMockGetAllParams{ctx, u1}
	...
	if mmGetAll.GetAllMock.defaultExpectation != nil {
		...
		mm_got := IPostLogicMockGetAllParams{ctx, u1}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	mmGetAll.t.Fatalf("Unexpected call to IPostLogicMock.GetAll. %v %v", ctx, u1)
	return
}
...
func (mmGetAllComments *mIPostLogicMockGetAllComments) Expect(ctx context.Context, postID uuid.UUID) *mIPostLogicMockGetAllComments {
	...
	mmGetAllComments.defaultExpectation.params = &IPostLogicMockGetAllCommentsParams{ctx, postID}
...
func (mmGetAllComments *mIPostLogicMockGetAllComments) Inspect(f func(ctx context.Context, postID uuid.UUID)) *mIPostLogicMockGetAllComments {
...
func (mmGetAllComments *mIPostLogicMockGetAllComments) Set(f func(ctx context.Context, postID uuid.UUID) (cpa1 []*models.Comment, err error)) *IPostLogicMock {
	if mmGetAllComments.defaultExpectation != nil {
...
// Then helper
func (mmGetAllComments *mIPostLogicMockGetAllComments) When(ctx context.Context, postID uuid.UUID) *IPostLogicMockGetAllCommentsExpectation {
	if mmGetAllComments.mock.funcGetAllComments != nil {
		mmGetAllComments.mock.t.Fatalf("IPostLogicMock.GetAllComments mock is already set by Set")
	}
	...
	expectation := &IPostLogicMockGetAllCommentsExpectation{
		...
		params: &IPostLogicMockGetAllCommentsParams{ctx, postID},
	}
...
func (mmGetAllComments *IPostLogicMock) GetAllComments(ctx context.Context, postID uuid.UUID) (cpa1 []*models.Comment, err error) {
	...
	if mmGetAllComments.inspectFuncGetAllComments != nil {
		mmGetAllComments.inspectFuncGetAllComments(ctx, postID)
	}

	mm_params := &IPostLogicMockGetAllCommentsParams{ctx, postID}
	...
	if mmGetAllComments.GetAllCommentsMock.defaultExpectation != nil {
		...
		mm_got := IPostLogicMockGetAllCommentsParams{ctx, postID}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	if mmGetAllComments.funcGetAllComments != nil {
		return mmGetAllComments.funcGetAllComments(ctx, postID)
	}
	mmGetAllComments.t.Fatalf("Unexpected call to IPostLogicMock.GetAllComments. %v %v", ctx, postID)
	return
}
