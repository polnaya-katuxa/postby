...
func (mmGetAll *mIPostRepositoryMockGetAll) Expect(ctx context.Context, u1 uuid.UUID) *mIPostRepositoryMockGetAll {
	...
	mmGetAll.defaultExpectation.params = &IPostRepositoryMockGetAllParams{ctx, u1}
...
func (mmGetAll *mIPostRepositoryMockGetAll) Inspect(f func(ctx context.Context, u1 uuid.UUID)) *mIPostRepositoryMockGetAll {
...
func (mmGetAll *mIPostRepositoryMockGetAll) Set(f func(ctx context.Context, u1 uuid.UUID) (ppa1 []*models.Post, err error)) *IPostRepositoryMock {
	if mmGetAll.defaultExpectation != nil {
...
// Then helper
func (mmGetAll *mIPostRepositoryMockGetAll) When(ctx context.Context, u1 uuid.UUID) *IPostRepositoryMockGetAllExpectation {
	if mmGetAll.mock.funcGetAll != nil {
		mmGetAll.mock.t.Fatalf("IPostRepositoryMock.GetAll mock is already set by Set")
	}
	...
	expectation := &IPostRepositoryMockGetAllExpectation{
		mock:   mmGetAll.mock,
		params: &IPostRepositoryMockGetAllParams{ctx, u1},
	}
...
func (mmGetAll *IPostRepositoryMock) GetAll(ctx context.Context, u1 uuid.UUID) (ppa1 []*models.Post, err error) {
	...
	mm_params := &IPostRepositoryMockGetAllParams{ctx, u1}
	...
	if mmGetAll.GetAllMock.defaultExpectation != nil {
		...
		mm_got := IPostRepositoryMockGetAllParams{ctx, u1}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	mmGetAll.t.Fatalf("Unexpected call to IPostRepositoryMock.GetAll. %v %v", ctx, u1)
	return
}
