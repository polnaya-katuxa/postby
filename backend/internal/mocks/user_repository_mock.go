...
func (mmGetAll *mIUserRepositoryMockGetAll) Expect(ctx context.Context) *mIUserRepositoryMockGetAll {
	...
	mmGetAll.defaultExpectation.params = &IUserRepositoryMockGetAllParams{ctx}
...
func (mmGetAll *mIUserRepositoryMockGetAll) Inspect(f func(ctx context.Context)) *mIUserRepositoryMockGetAll {
...
func (mmGetAll *mIUserRepositoryMockGetAll) Set(f func(ctx context.Context) (upa1 []*models.User, err error)) *IUserRepositoryMock {
	if mmGetAll.defaultExpectation != nil {
...
// Then helper
func (mmGetAll *mIUserRepositoryMockGetAll) When(ctx context.Context) *IUserRepositoryMockGetAllExpectation {
	if mmGetAll.mock.funcGetAll != nil {
		mmGetAll.mock.t.Fatalf("IUserRepositoryMock.GetAll mock is already set by Set")
	}
	...
	expectation := &IUserRepositoryMockGetAllExpectation{
		mock:   mmGetAll.mock,
		params: &IUserRepositoryMockGetAllParams{ctx},
	}
...
func (mmGetAll *IUserRepositoryMock) GetAll(ctx context.Context) (upa1 []*models.User, err error) {
	...
	mm_params := &IUserRepositoryMockGetAllParams{ctx}
	...
	if mmGetAll.GetAllMock.defaultExpectation != nil {
		...
		mm_got := IUserRepositoryMockGetAllParams{ctx}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	mmGetAll.t.Fatalf("Unexpected call to IUserRepositoryMock.GetAll. %v", ctx)
	return
}
