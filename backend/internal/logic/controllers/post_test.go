...
func TestPost_getReactions(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			fields: fields{
				postRepo:                nil,
				reactionRepo:            mocks.NewReactionRepositoryMock(mc).GetAllMock.Return(r, nil),
				balanceTransactionLogic: nil,
				subscriptionLogic:       nil,
			},
			args: args{
		...
		},
		{
			...
			fields: fields{
				postRepo:                nil,
				reactionRepo:            mocks.NewReactionRepositoryMock(mc).GetAllMock.Return(r, errors.New("error")),
				balanceTransactionLogic: nil,
				subscriptionLogic:       nil,
			},
			args: args{
...
func TestPost_GetAll(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := p.GetAll(tt.args.ctx, tt.args.userID)
			if (err != nil) != tt.wantErr {
...
func TestPost_React(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			fields: fields{
				postRepo:                mocks.NewIPostRepositoryMock(mc).GetMock.Return(post, nil),
				reactionRepo:            mocks.NewReactionRepositoryMock(mc).ReactedMock.Return(false, errors.New("error")),
				balanceTransactionLogic: nil,
				subscriptionLogic:       nil,
			},
			args: args{
		...
		},
		{
			...
			fields: fields{
				postRepo:                mocks.NewIPostRepositoryMock(mc).GetMock.Return(post, nil),
				reactionRepo:            mocks.NewReactionRepositoryMock(mc).ReactedMock.Return(true, nil).DeleteMock.Return(errors.New("error")),
				balanceTransactionLogic: nil,
				subscriptionLogic:       nil,
			},
			args: args{
		...
		},
		{
			...
			fields: fields{
				postRepo:                mocks.NewIPostRepositoryMock(mc).GetMock.Return(post, nil),
				reactionRepo:            mocks.NewReactionRepositoryMock(mc).ReactedMock.Return(false, nil).CreateMock.Return(errors.New("error")),
				balanceTransactionLogic: nil,
				subscriptionLogic:       nil,
			},
			args: args{
		...
		},
		{
			...
			fields: fields{
				postRepo:                mocks.NewIPostRepositoryMock(mc).GetMock.Return(post, nil),
				reactionRepo:            mocks.NewReactionRepositoryMock(mc).ReactedMock.Return(false, nil).CreateMock.Return(nil),
				balanceTransactionLogic: nil,
				subscriptionLogic:       nil,
			},
			args: args{
...
func TestPost_GetAllComments(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := p.GetAllComments(tt.args.ctx, tt.args.postID)
			if (err != nil) != tt.wantErr {
